...
const topics = [
  ...
  { title: 'Verbal & Reasoning', content: [{ name: 'Verbal Ability', path: '/test/verbal-ability' }, { name: 'Logical Reasoning', path: '/test/logical-reasoning' }, { name: 'Verbal Reasoning', path: '/test/verbal-reasoning' }] },
