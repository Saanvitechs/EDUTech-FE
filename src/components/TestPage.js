...
//                 <div
//                   key={index}
//                   className={`question-number ${responses[question.id] ? 'answered' : ''}`}
...
//               <button className="mark-button">Mark for Review & Next</button>
//               <button className="clear-button">Clear Response</button>
