...
const PricingPage = () => {
  const pricingPlans = [
    ...
    },
    {
      ...
      buttonText: 'Get Started',
      isFeatured: true,
      color: '#EDE7F6', // Purple background
      buttonColor: '#6f42c1',
      borderColor: '#6f42c1', // Purple border
    },
    {
      title: 'Enterprise Package',
      price: 1600,
      features: ['12 Hours of Consulting', 'Email, Phone, and Chat Support', 'Detailed Report with In-depth Analysis'],
      buttonText: 'Get Started',
      color: '#E3F2FD', // Dark Blue background
      buttonColor: '#3f51b5',
      borderColor: 'transparent',
    },
  ];
          ...
          >
            <Card
              style={{
                ...
                borderRadius: '15px',
                boxShadow: plan.isFeatured
                  ? '0 0 0 3px' // Border only for featured card
                  : '0 10px 20px rgba(0, 0, 0, 0.1)',
                border: plan.isFeatured ? `2px solid ${plan.borderColor}` : 'none', // Add border for featured card
                padding: '20px',
                transition: 'transform 0.5s ease-in-out, box-shadow 0.5s ease-in-out',
                position: 'relative',
              }}
